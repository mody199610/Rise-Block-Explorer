        ...
        function (err, results) {
            if (err) {
                ...
                var statistics = {
                    ...
                    riseVolume : _.reduce(results[0], function (memo, t) { return (memo + parseFloat(t.riseVolume)); }, 0.0).toFixed(8),
                ...
                statistics = {
                    ...
                    riseVolume : statistics.riseVolume,
