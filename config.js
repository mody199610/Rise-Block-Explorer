...
// LISK node
config.lisk.host = '0.0.0.0';
config.lisk.port = 4242;
...
//config.exchangeRates.exchanges.RISE.BTC = 'RISEBTC'; // LSK/BTC pair, supported: poloniex
//config.exchangeRates.exchanges.BTC.USD = 'BTCUSD'; // BTC/USD pair, supported: bitfinex, bitstamp, btce
//config.exchangeRates.exchanges.BTC.EUR = 'false'; // BTC/EUR pair, supported: bitstamp, bitmarket
